...
> **Electron 桌面端特色**：
> - 🖥️ **独立原生桌面窗口**：专属独立界面，无需依赖浏览器标签页。
> - 📌 **托盘常驻与后台监听**：关闭窗口自动最小化至系统托盘，后台持续捕获并记录 Hermes 对话 Token。
> - 🎨 **内嵌专属 Hermes 高分图标**与托盘右键菜单。

---

### 方法 2：双击独立 EXE 启动器（轻量版）
...
> - 💻 **右下角系统托盘菜单 (System Tray)**：双击托盘图标即可随时打开监控大屏。
>
> 另外也保留了批处理脚本：
